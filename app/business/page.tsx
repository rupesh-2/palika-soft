...
import { Building2, Upload, CheckCircle, Download, Search, Globe, User, MapPin, QrCode } from "lucide-react"
      ...
      <div className="md:ml-64 p-4 md:p-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="certificates">{language === "en" ? "Certificates" : "प्रमाणपत्रहरू"}</TabsTrigger>
          </TabsList>
                    ...
                    <div key={step.id} className="flex items-center">
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                          currentStep >= step.id ? "bg-[#1F4E79] text-white" : "bg-gray-200 text-gray-600"
                        }`}
                      >
                        {currentStep > step.id ? <CheckCircle className="h-4 w-4" /> : step.id}
                      </div>
                      <div className="ml-2 text-sm">
                        <div className="font-medium">{language === "en" ? step.title : step.titleNp}</div>
                      </div>
                      {index < registrationSteps.length - 1 && <div className="w-16 h-0.5 bg-gray-200 mx-4"></div>}
                    </div>
                  ))}
                </div>
                <Progress value={(currentStep / registrationSteps.length) * 100} className="h-2" />
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                {currentStep === 1 && (
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="business-name-en">
                          {language === "en" ? "Business Name (English)" : "व्यवसायको नाम (अंग्रेजी)"}
                        </Label>
                        <Input
                          id="business-name-en"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="business-name-np">
                          {language === "en" ? "Business Name (Nepali)" : "व्यवसायको नाम (नेपाली)"}
                        </Label>
                        <Input
                          id="business-name-np"
                          placeholder="व्यवसायको नाम लेख्नुहोस्"
                          value={formData.businessNameNp}
                          onChange={(e) => handleInputChange("businessNameNp", e.target.value)}
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="business-type">{language === "en" ? "Business Type" : "व्यवसायको प्रकार"}</Label>
                        <Select
                        ...
                        >
                          <SelectTrigger>
                            <SelectValue
                              placeholder={language === "en" ? "Select business type" : "व्यवसायको प्रकार छान्नुहोस्"}
                            />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="business-address">
                        {language === "en" ? "Business Address" : "व्यवसायको ठेगाना"}
                      </Label>
                      <Textarea
                        id="business-address"
                        placeholder={
                          language === "en" ? "Enter complete business address" : "पूरा व्यवसायिक ठेगाना लेख्नुहोस्"
                        }
                        rows={3}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="business-description">
                        {language === "en" ? "Business Description" : "व्यवसायको विवरण"}
                      </Label>
                      <Textarea
                ...
                {currentStep === 2 && (
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="owner-name">{language === "en" ? "Owner Full Name" : "मालिकको पूरा नाम"}</Label>
                        <Input
                          id="owner-name"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="pan-no">{language === "en" ? "PAN Number" : "प्यान नम्बर"}</Label>
                        <Input
                          id="pan-no"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="dob">{language === "en" ? "Date of Birth" : "जन्म मिति"}</Label>
                        <Input
                          id="dob"
                          type="date"
                          value={formData.dob}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="owner-address">{language === "en" ? "Owner Address" : "मालिकको ठेगाना"}</Label>
                      <Textarea
                        id="owner-address"
                        placeholder={language === "en" ? "Enter permanent address" : "स्थायी ठेगाना लेख्नुहोस्"}
                        rows={3}
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Card className="border-dashed border-2 border-gray-300">
                        <CardContent className="p-6 text-center">
                          ...
                          <h3 className="font-medium mb-2">
                            {language === "en" ? "Citizenship Certificate" : "नागरिकता प्रमाणपत्र"}
                          </h3>
                          <p className="text-sm text-gray-600 mb-4">
                            {language === "en" ? "Upload scanned copy" : "स्क्यान गरिएको प्रतिलिपि अपलोड गर्नुहोस्"}
                          </p>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() =>
                              handleFileUpload(language === "en" ? "Citizenship Certificate" : "नागरिकता प्रमाणपत्र")
                            }
                          >
                      ...
                      <Card className="border-dashed border-2 border-gray-300">
                        <CardContent className="p-6 text-center">
                          <Upload className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                          <h3 className="font-medium mb-2">
                            {language === "en" ? "PAN Certificate" : "प्यान प्रमाणपत्र"}
                          </h3>
                          <p className="text-sm text-gray-600 mb-4">
                            {language === "en" ? "Upload scanned copy" : "स्क्यान गरिएको प्रतिलिपि अपलोड गर्नुहोस्"}
                          </p>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => handleFileUpload(language === "en" ? "PAN Certificate" : "प्यान प्रमाणपत्र")}
                          >
                            <Upload className="h-4 w-4 mr-2" />
                            {language === "en" ? "Choose File" : "फाइल छान्नुहोस्"}
                          </Button>
                    ...
                    <Card className="border-dashed border-2 border-gray-300">
                      <CardContent className="p-6 text-center">
                        <Upload className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                        <h3 className="font-medium mb-2">
                          {language === "en" ? "Location Map/Property Document" : "स्थान नक्सा/सम्पत्ति कागजात"}
                        </h3>
                        <p className="text-sm text-gray-600 mb-4">
                          {language === "en" ? "Upload business location proof" : "व्यवसायिक स्थानको प्रमाण अपलोड गर्नुहोस्"}
                        </p>
                        <Button
                          variant="outline"
                          size="sm"
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 p-6 rounded-lg">
                      <h3 className="font-medium text-[#1F4E79] mb-4">
                        {language === "en" ? "Application Summary" : "आवेदन सारांश"}
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="font-medium">{language === "en" ? "Business Name:" : "व्यवसायको नाम:"}</span>
                          <span className="ml-2">{formData.businessNameEn}</span>
                        </div>
                        <div>
                          <span className="font-medium">
                            {language === "en" ? "Business Type:" : "व्यवसायको प्रकार:"}
                          </span>
                          <span className="ml-2">{formData.businessType}</span>
                        </div>
                        <div>
                          <span className="font-medium">{language === "en" ? "Owner Name:" : "मालिकको नाम:"}</span>
                          <span className="ml-2">{formData.ownerName}</span>
                        </div>
                        <div>
                          <span className="font-medium">{language === "en" ? "Ward:" : "वडा:"}</span>
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      ...
                      <ul className="text-sm text-yellow-700 space-y-1">
                        ...
                        <li>
                          • {language === "en" ? "Physical inspection may be required" : "भौतिक निरीक्षण आवश्यक पर्न सक्छ"}
                        </li>
                        <li>• {language === "en" ? "Registration fee: Rs. 2,000" : "दर्ता शुल्क: रु. २,०००"}</li>
                      </ul>
                    </div>
                  </div>
                )}
                ...
                <div className="flex justify-between pt-6">
                  ...
                  <Button className="bg-[#1F4E79] hover:bg-[#1F4E79]/90" onClick={handleSubmitApplication}>
                ...
                <Card key={app.id} className="border-l-4 border-l-[#FFC107]">
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      <div>
                        <CardTitle className="text-[#1F4E79]">{app.businessName}</CardTitle>
                        <div className="flex items-center space-x-4 mt-2">
                          <Badge className={`${getStatusColor(app.status)} text-white`}>
                            {getStatusText(app.status)}
                          </Badge>
                          <span className="text-sm text-gray-600">ID: {app.id}</span>
                      ...
                      <div className="text-right">
                        <div className="text-sm text-gray-600">{language === "en" ? "Submitted" : "पेश गरिएको"}</div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">
                          {language === "en" ? "Current Step:" : "हालको चरण:"} {app.currentStep}
                        </span>
          ...
          <TabsContent value="database" className="space-y-6">
            <Card>
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle className="text-[#1F4E79]">
                    {language === "en" ? "Registered Businesses" : "दर्ता भएका व्यवसायहरू"}
                  </CardTitle>
                  <div className="flex items-center space-x-4">
                    <div className="relative">
                      <Search className="h-4 w-4 absolute left-3 top-3 text-gray-400" />
                      <Input
                        placeholder={language === "en" ? "Search businesses..." : "व्यवसायहरू खोज्नुहोस्..."}
                        value={searchTerm}
              ...
              <CardContent>
                <div className="space-y-4">
                  {filteredBusinesses.map((business) => (
                    <Card key={business.id} className="border-l-4 border-l-green-500">
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                          <div className="space-y-2">
                            <div>
                              <h3 className="font-medium text-[#1F4E79]">
                                {language === "en" ? business.name : business.nameNp}
                              </h3>
                          ...
                          <div className="text-right space-y-2">
                            ...
                            <div className="text-xs text-gray-500">
                              {language === "en" ? "Renewal:" : "नवीकरण:"} {business.renewalDate}
                            </div>
                          </div>
                        </div>
                      </CardContent>
          ...
          <TabsContent value="certificates" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-[#1F4E79]">
                  {language === "en" ? "Business Certificates" : "व्यवसायिक प्रमाणपत्रहरू"}
                </CardTitle>
                <CardDescription>
                  {language === "en"
              ...
              <CardContent>
                <div className="space-y-4">
                  {registeredBusinesses
                    ...
                    .map((business) => (
                      <Card key={business.id} className="border-l-4 border-l-[#1F4E79]">
                        <CardContent className="p-4">
                          <div className="flex justify-between items-center">
                            <div className="space-y-1">
                              ...
                              <p className="text-sm text-gray-600">
                                {language === "en" ? "Registration ID:" : "दर्ता नम्बर:"} {business.id}
                              </p>
                              <p className="text-xs text-gray-500">
                                {language === "en" ? "Issued:" : "जारी मिति:"} {business.registrationDate}
                              </p>
                            </div>
                            <div className="flex items-center space-x-2">
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleQRCodeGeneration(language === "en" ? business.name : business.nameNp)
                                }
                              >
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleCertificateDownload(language === "en" ? business.name : business.nameNp)
                                }
                              >
